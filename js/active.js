...
(function ($) {
    ...
    $('.team-member-silder-active').slick({
        ...
        centerMode: true,
        prevArrow:
            '<span class="slider-navigation slider-navigation-prev"><i class="fa fa-angle-left"></i></span>',
        nextArrow:
            '<span class="slider-navigation slider-navigation-next"><i class="fa fa-angle-right"></i></span>',
        responsive: [
            {
                breakpoint: 992,
                settings: {
    ...
    $('.testimonial-wrap').slick({
        ...
        arrows: false,
        prevArrow:
            '<span class="cr-navigation cr-navigation-prev"><i class="fa fa-angle-left"></i></span>',
        nextArrow:
            '<span class="cr-navigation cr-navigation-next"><i class="fa fa-angle-right"></i></span>',
        adaptiveHeight: true,
        dots: true,
        dotsClass: 'cr-slider-dots',
        fade: false,
    ...
    $('nav.bk-navigation').meanmenu({
        meanMenuClose:
            '<img src="images/icons/icon-close.png" alt="close icon">',
    ...
    if ($('#sidebar-instagram-feed').length) {
        var userFeed = new Instafeed({
            ...
            limit: 4,
            template:
                '<div class="sidebar-instafeed-single"><a href="{{link}}" target="_new"><img src="{{image}}" /><span>{{caption}}</span></a></div>',
